...
- Terraform
- [v1.15.x (alpha)](/terraform/language/v1.15.x/backend)
- [v1.13.x](/terraform/language/v1.13.x/backend)
- [v1.12.x](/terraform/language/v1.12.x/backend)
- [v1.11.x](/terraform/language/v1.11.x/backend)
- [v1.10.x](/terraform/language/v1.10.x/backend)
- [v1.9.x](/terraform/language/v1.9.x/backend)
- [v1.8.x](/terraform/language/v1.8.x/backend)
- [v1.7.x](/terraform/language/v1.7.x/backend)
- [v1.6.x](/terraform/language/v1.6.x/backend)
- [v1.5.x](/terraform/language/v1.5.x/backend)
- [v1.4.x](/terraform/language/v1.4.x/backend)
- [v1.3.x](/terraform/language/v1.3.x/backend)
- [v1.2.x](/terraform/language/v1.2.x/backend)
- [v1.1.x](/terraform/language/v1.1.x/backend)
...
the arguments are omitted, we call this a *partial configuration*.
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/terraform/v1.14.x/docs/language/backend/index.mdx)