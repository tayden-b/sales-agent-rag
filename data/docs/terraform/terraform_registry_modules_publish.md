...
match the [naming convention described above](/terraform/registry/modules/publish#requirements). This is shown in
...
![Publish Module flow animation](https://web-unified-docs-hashicorp.vercel.app/api/assets/terraform-docs-common/latest/img/docs/registry-publish.gif)
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/terraform-docs-common//docs/registry/modules/publish.mdx)