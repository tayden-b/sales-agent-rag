...
- Terraform
- [v1.15.x (alpha)](/terraform/language/v1.15.x/values/variables)
- [v1.13.x](/terraform/language/v1.13.x/values/variables)
- [v1.12.x](/terraform/language/v1.12.x/values/variables)
- [v1.11.x](/terraform/language/v1.11.x/values/variables)
- [v1.10.x](/terraform/language/v1.10.x/values/variables)
- [v1.9.x](/terraform/language/v1.9.x/values/variables)
- [v1.8.x](/terraform/language/v1.8.x/values/variables)
- [v1.7.x](/terraform/language/v1.7.x/values/variables)
- [v1.6.x](/terraform/language/v1.6.x/values/variables)
- [v1.5.x](/terraform/language/v1.5.x/values/variables)
- [v1.4.x](/terraform/language/v1.4.x/values/variables)
- [v1.3.x](/terraform/language/v1.3.x/values/variables)
- [v1.2.x](/terraform/language/v1.2.x/values/variables)
- [v1.1.x](/terraform/language/v1.1.x/values/variables)
...
- [HCP Terraform variables and variable sets](/terraform/language/values/variables#hcp-terraform)
- The `-var` and `-var-file` options on the [CLI](/terraform/language/values/variables#command-line-variables)
- [Variable definition files](/terraform/language/values/variables#variable-definition-files)
- [Environment variables](/terraform/language/values/variables#environment-variables)
...
1. Any `-var` and `-var-file` options on the [command line](/terraform/language/values/variables#command-line-variables) in the order provided and variables from HCP Terraform
...
For readability, and to avoid shell escaping, we recommend setting complex variable values with [variable definition files](/terraform/language/values/variables#variable-definition-files). For more details on shell quoting and the Windows command prompt, refer to [Input variables on the command line](/terraform/cli/commands/plan#input-variables-on-the-command-line).
...
For readability, and to avoid shell escaping, we recommend setting complex variable values with [variable definition files](/terraform/language/values/variables#variable-definition-files).

### Undeclared variables

Terraform handles setting values for undeclared variables differently depending on how you assign that value:

- Terraform ignores any assigned [environment variables](/terraform/language/values/variables#environment-variables) that do not have a matching `variable` block.
- Terraform warns you if you assign an undeclared variable in a [variable definition file](/terraform/language/values/variables#variable-definition-files), letting you catch accidental misspellings in your configuration or definition files.
- Terraform errors if you attempt to assign a value for an undeclared variable with `-var` on the command line.

[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/terraform/v1.14.x/docs/language/values/variables.mdx)