...
- Terraform
- [v1.15.x (alpha)](/terraform/language/v1.15.x/state)
- [v1.13.x](/terraform/language/v1.13.x/state)
- [v1.12.x](/terraform/language/v1.12.x/state)
- [v1.11.x](/terraform/language/v1.11.x/state)
- [v1.10.x](/terraform/language/v1.10.x/state)
- [v1.9.x](/terraform/language/v1.9.x/state)
- [v1.8.x](/terraform/language/v1.8.x/state)
- [v1.7.x](/terraform/language/v1.7.x/state)
- [v1.6.x](/terraform/language/v1.6.x/state)
- [v1.5.x](/terraform/language/v1.5.x/state)
- [v1.4.x](/terraform/language/v1.4.x/state)
- [v1.3.x](/terraform/language/v1.3.x/state)
- [v1.2.x](/terraform/language/v1.2.x/state)
- [v1.1.x](/terraform/language/v1.1.x/state)
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/terraform/v1.14.x/docs/language/state/index.mdx)