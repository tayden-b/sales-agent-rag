# Source: https://developer.hashicorp.com/terraform/cloud-docs/recommended-practices/part1
...
2. Organizational complexity — As infrastructure scales, it requires more teams to maintain it. For effective collaboration, it's important to delegate ownership of infrastructure across these teams and empower them to work in parallel without conflict. Terraform and HCP Terraform can help delegate infrastructure in the same way components of a large application are delegated.
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/terraform-docs-common//docs/cloud-docs/recommended-practices/part1.mdx)