# Source: https://developer.hashicorp.com/terraform/language/modules/develop

v1.14.x (latest)

- Terraform
- [v1.15.x (alpha)](/terraform/language/v1.15.x/modules/develop)
- [v1.13.x](/terraform/language/v1.13.x/modules/develop)
- [v1.12.x](/terraform/language/v1.12.x/modules/develop)
- [v1.11.x](/terraform/language/v1.11.x/modules/develop)
- [v1.10.x](/terraform/language/v1.10.x/modules/develop)
- [v1.9.x](/terraform/language/v1.9.x/modules/develop)
- [v1.8.x](/terraform/language/v1.8.x/modules/develop)
- [v1.7.x](/terraform/language/v1.7.x/modules/develop)
- [v1.6.x](/terraform/language/v1.6.x/modules/develop)
- [v1.5.x](/terraform/language/v1.5.x/modules/develop)
- [v1.4.x](/terraform/language/v1.4.x/modules/develop)
- [v1.3.x](/terraform/language/v1.3.x/modules/develop)
- [v1.2.x](/terraform/language/v1.2.x/modules/develop)
- [v1.1.x](/terraform/language/v1.1.x/modules/develop)
...
or [`terraform apply`](/terraform/cli/commands/apply) together form the *root*
...
To learn how to *use* modules, see [the Modules configuration section](/terraform/language/modules).
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/terraform/v1.14.x/docs/language/modules/develop/index.mdx)