...
- Terraform
- [v1.15.x (alpha)](/terraform/language/v1.15.x/data-sources)
- [v1.13.x](/terraform/language/v1.13.x/data-sources)
- [v1.12.x](/terraform/language/v1.12.x/data-sources)
- [v1.11.x](/terraform/language/v1.11.x/data-sources)
- [v1.10.x](/terraform/language/v1.10.x/data-sources)
- [v1.9.x](/terraform/language/v1.9.x/data-sources)
- [v1.8.x](/terraform/language/v1.8.x/data-sources)
- [v1.7.x](/terraform/language/v1.7.x/data-sources)
- [v1.6.x](/terraform/language/v1.6.x/data-sources)
- [v1.5.x](/terraform/language/v1.5.x/data-sources)
- [v1.4.x](/terraform/language/v1.4.x/data-sources)
- [v1.3.x](/terraform/language/v1.3.x/data-sources)
- [v1.2.x](/terraform/language/v1.2.x/data-sources)
- [v1.1.x](/terraform/language/v1.1.x/data-sources)
...
- The `data` block configuration has [custom conditions](/terraform/language/data-sources#custom-condition-checks) that directly or indirectly depend on a Terraform-managed resource configured to change in the current plan.
- Arguments in a `data` block refer to values that must be computed during the apply phase.

When the data source depends on other objects, query results are unknown during the plan operation. As a result, Terraform can't provision resources that reference the fetched values until the apply phase. Refer to [Configure dependencies](/terraform/language/data-sources#dependencies) for more information about dependencies.
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/terraform/v1.14.x/docs/language/data-sources/index.mdx)