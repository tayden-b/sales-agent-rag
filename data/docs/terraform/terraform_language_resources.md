...
- Terraform
- [v1.15.x (alpha)](/terraform/language/v1.15.x/resources)
- [v1.13.x](/terraform/language/v1.13.x/resources)
- [v1.12.x](/terraform/language/v1.12.x/resources)
- [v1.11.x](/terraform/language/v1.11.x/resources)
- [v1.10.x](/terraform/language/v1.10.x/resources)
- [v1.9.x](/terraform/language/v1.9.x/resources)
- [v1.8.x](/terraform/language/v1.8.x/resources)
- [v1.7.x](/terraform/language/v1.7.x/resources)
- [v1.6.x](/terraform/language/v1.6.x/resources)
- [v1.5.x](/terraform/language/v1.5.x/resources)
- [v1.4.x](/terraform/language/v1.4.x/resources)
- [v1.3.x](/terraform/language/v1.3.x/resources)
- [v1.2.x](/terraform/language/v1.2.x/resources)
- [v1.1.x](/terraform/language/v1.1.x/resources)
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/terraform/v1.14.x/docs/language/resources/index.mdx)