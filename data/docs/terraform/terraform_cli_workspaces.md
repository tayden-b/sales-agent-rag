...
- Terraform
- [v1.15.x (alpha)](/terraform/cli/v1.15.x/workspaces)
- [v1.13.x](/terraform/cli/v1.13.x/workspaces)
- [v1.12.x](/terraform/cli/v1.12.x/workspaces)
- [v1.11.x](/terraform/cli/v1.11.x/workspaces)
- [v1.10.x](/terraform/cli/v1.10.x/workspaces)
- [v1.9.x](/terraform/cli/v1.9.x/workspaces)
- [v1.8.x](/terraform/cli/v1.8.x/workspaces)
- [v1.7.x](/terraform/cli/v1.7.x/workspaces)
- [v1.6.x](/terraform/cli/v1.6.x/workspaces)
- [v1.5.x](/terraform/cli/v1.5.x/workspaces)
- [v1.4.x](/terraform/cli/v1.4.x/workspaces)
- [v1.3.x](/terraform/cli/v1.3.x/workspaces)
- [v1.2.x](/terraform/cli/v1.2.x/workspaces)
- [v1.1.x](/terraform/cli/v1.1.x/workspaces)
...
Workspaces can be helpful for specific [use cases](/terraform/cli/workspaces#use-cases), but they are not required to use the Terraform CLI. We recommend using [alternative approaches](/terraform/cli/workspaces#alternatives-to-workspaces) for complex deployments requiring separate credentials and access controls.
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/terraform/v1.14.x/docs/cli/workspaces/index.mdx)