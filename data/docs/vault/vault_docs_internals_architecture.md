# Source: https://developer.hashicorp.com/vault/docs/internals/architecture

v1.21.x (latest)

- Vault
- [v1.20.x](/vault/docs/v1.20.x/internals/architecture)
- [v1.19.x](/vault/docs/v1.19.x/internals/architecture)
- [v1.18.x](/vault/docs/v1.18.x/internals/architecture)
- [v1.17.x](/vault/docs/v1.17.x/internals/architecture)
- [v1.16.x](/vault/docs/v1.16.x/internals/architecture)
- ---
...
[![Architecture Overview](https://web-unified-docs-hashicorp.vercel.app/api/assets/vault/latest/img/layers.png)](https://web-unified-docs-hashicorp.vercel.app/api/assets/vault/latest/img/layers.png)
...
When a Vault server is started, it begins in a *sealed* state. Before any
operation can be performed on Vault, it must be *unsealed*. This is done by
...
![Unseal keys](https://web-unified-docs-hashicorp.vercel.app/api/assets/vault/latest/img/vault-shamir-seal.png)
...
data in the storage backend, and enters the *unsealed* state. Once unsealed,
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/vault/v1.21.x/content/docs/internals/architecture.mdx)