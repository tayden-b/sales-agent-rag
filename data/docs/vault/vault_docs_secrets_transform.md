# Source: https://developer.hashicorp.com/vault/docs/secrets/transform

v1.21.x (latest)

- Vault
- [v1.20.x](/vault/docs/v1.20.x/secrets/transform)
- [v1.19.x](/vault/docs/v1.19.x/secrets/transform)
- [v1.18.x](/vault/docs/v1.18.x/secrets/transform)
- [v1.17.x](/vault/docs/v1.17.x/secrets/transform)
- [v1.16.x](/vault/docs/v1.16.x/secrets/transform)
- ---
...
3. Decode some input value using the `/decode` endpoint with a named role and decode format:
...
- [`supplied`](/vault/docs/secrets/transform#supplied): This is the default behavior for FPE transformations. The tweak
  value must be generated externally, and supplied into the on encode and decode
  operations.
- [`generated`](/vault/docs/secrets/transform#generated): The secret engine will take care of generating the tweak value
...
- [`internal`](/vault/docs/secrets/transform#internal): The secret engine will generate an internal tweak value per
...
non-sensitive *metadata* can be encoded alongside the value, and retrieved either
...
- If the HSM supports the CKM\_RSA\_AES\_KEY\_WRAP mechanism, it can be used to wrap the
...
- Otherwise, two mechanisms can be combined to wrap the target key. First, a 256-bit AES key is
  generated and then used to wrap the target key using the CKM\_AES\_KEY\_WRAP\_KWP mechanism.
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/vault/v1.21.x/content/docs/secrets/transform/index.mdx)