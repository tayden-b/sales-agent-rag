# Source: https://developer.hashicorp.com/vault/docs/configuration/storage/raft

v1.21.x (latest)

- Vault
- [v1.20.x](/vault/docs/v1.20.x/configuration/storage/raft)
- [v1.19.x](/vault/docs/v1.19.x/configuration/storage/raft)
- [v1.18.x](/vault/docs/v1.18.x/configuration/storage/raft)
- [v1.17.x](/vault/docs/v1.17.x/configuration/storage/raft)
- [v1.16.x](/vault/docs/v1.16.x/configuration/storage/raft)
- ---
...
Algorithm](https://raft.github.io/ "The Raft Consensus Algorithm").
...
- [`path`](/vault/docs/configuration/storage/raft#path) `(string: "")` – The file system path where all the Vault data gets
  stored.
  This value can be overridden by setting the `VAULT_RAFT_PATH` environment variable.
- [`node_id`](/vault/docs/configuration/storage/raft#node_id) `(string: "")` - The identifier for the node in the Raft cluster.
...
- [`performance_multiplier`](/vault/docs/configuration/storage/raft#performance_multiplier) `(integer: 5)` - An integer multiplier used by
...
- [`trailing_logs`](/vault/docs/configuration/storage/raft#trailing_logs) `(integer: 10000)` - This controls how many log entries are
...
- [`snapshot_threshold`](/vault/docs/configuration/storage/raft#snapshot_threshold) `(integer: 8192)` - This controls the minimum number of Raft
...
- [`snapshot_interval`](/vault/docs/configuration/storage/raft#snapshot_interval) `(integer: 120 seconds)` - The snapshot interval
  ...
  120 seconds.
- [`retry_join`](/vault/docs/configuration/storage/raft#retry_join) `(list: [])` - A set of connection details for another node in the
  cluster, which is used to help nodes locate a leader in order to join a cluster.
  There can be one or more [`retry_join`](/vault/docs/configuration/storage/raft#retry_join-stanza) stanzas.
  ...
  their [`retry_join`](/vault/docs/configuration/storage/raft#retry_join-stanza) configuration to locate the leader and
  join the cluster. Note that when using Shamir seal, the joined nodes will still
  need to be unsealed manually.
  See [the section below](/vault/docs/configuration/storage/raft#retry_join-stanza) for the parameters accepted by the
  [`retry_join`](/vault/docs/configuration/storage/raft#retry_join-stanza) stanza.
- [`retry_join_as_non_voter`](/vault/docs/configuration/storage/raft#retry_join_as_non_voter) `(boolean: false)` - 
...
- [`max_entry_size`](/vault/docs/configuration/storage/raft#max_entry_size) `(integer: 1048576)` - This configures the maximum number of
...
- [`max_mount_and_namespace_table_entry_size`](/vault/docs/configuration/storage/raft#max_mount_and_namespace_table_entry_size) `(integer)`- 

  Enterprise

   Overrides `max_entry_size` to set a different limit for the specific
  ...
  notes on [`max_entry_size`](/vault/docs/configuration/storage/raft#max-entry-size) apply. Before changing this, read
...
- [`autopilot_reconcile_interval`](/vault/docs/configuration/storage/raft#autopilot_reconcile_interval) `(string: "10s")` - This is the interval after
...
- [`autopilot_update_interval`](/vault/docs/configuration/storage/raft#autopilot_update_interval) `(string: "2s")` - This is the interval after which
...
- [`autopilot_upgrade_version`](/vault/docs/configuration/storage/raft#autopilot_upgrade_version) `(string: "")` - 
...
- [`autopilot_redundancy_zone`](/vault/docs/configuration/storage/raft#autopilot_redundancy_zone) `(string: "")` - 
...
- [`raft_wal`](/vault/docs/configuration/storage/raft#raft_wal) `(boolean: false)` - Enables the
...
- [`raft_log_verifier_enabled`](/vault/docs/configuration/storage/raft#raft_log_verifier_enabled) `(boolean: false)` - Enables the raft log verifier.
...
- [`raft_log_verification_interval`](/vault/docs/configuration/storage/raft#raft_log_verification_interval) `(string: "60s")` - Sets the interval at
...
- [`leader_api_addr`](/vault/docs/configuration/storage/raft#leader_api_addr) `(string: "")` - Address of a possible leader node.
- [`auto_join`](/vault/docs/configuration/storage/raft#auto_join) `(string: "")` - Cloud auto-join configuration, using
  ...
  use IPv4 addresses.
- [`auto_join_scheme`](/vault/docs/configuration/storage/raft#auto_join_scheme) `(string: "")` - The optional URI protocol scheme for addresses
  discovered via auto-join. Available values are `http` or `https`.
- [`auto_join_port`](/vault/docs/configuration/storage/raft#auto_join_port) `(uint: "")` - The optional port used for addressed discovered
  via auto-join.
- [`leader_tls_servername`](/vault/docs/configuration/storage/raft#leader_tls_servername) `(string: "")` - The TLS server name to use when
...
- [`leader_ca_cert_file`](/vault/docs/configuration/storage/raft#leader_ca_cert_file) `(string: "")` - File path to the CA cert of the
  possible leader node.
- [`leader_client_cert_file`](/vault/docs/configuration/storage/raft#leader_client_cert_file) `(string: "")` - File path to the client certificate
  for the follower node to establish client authentication with the possible
  leader node.
- [`leader_client_key_file`](/vault/docs/configuration/storage/raft#leader_client_key_file) `(string: "")` - File path to the client key for the
  follower node to establish client authentication with the possible leader node.
- [`leader_ca_cert`](/vault/docs/configuration/storage/raft#leader_ca_cert) `(string: "")` - CA cert of the possible leader node.
- [`leader_client_cert`](/vault/docs/configuration/storage/raft#leader_client_cert) `(string: "")` - Client certificate for the follower node
  to establish client authentication with the possible leader node.
- [`leader_client_key`](/vault/docs/configuration/storage/raft#leader_client_key) `(string: "")` - Client key for the follower node to
  establish client authentication with the possible leader node.

Each [`retry_join`](/vault/docs/configuration/storage/raft#retry_join-stanza) block may provide TLS certificates via
file paths or as a single-line certificate string value with newlines delimited
by `\n`, but not a combination of both. Each [`retry_join`](/vault/docs/configuration/storage/raft#retry_join-stanza)
stanza may contain either a [`leader_api_addr`](/vault/docs/configuration/storage/raft#leader_api_addr) value or a
cloud [`auto_join`](/vault/docs/configuration/storage/raft#auto_join) configuration value, but not both. When an
[`auto_join`](/vault/docs/configuration/storage/raft#auto_join) value is provided, Vault will automatically attempt to
...
[`auto_join_scheme`](/vault/docs/configuration/storage/raft#auto_join_scheme) and [`auto_join_port`](/vault/docs/configuration/storage/raft#auto_join_port)
fields respectively.
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/vault/v1.21.x/content/docs/configuration/storage/raft.mdx)