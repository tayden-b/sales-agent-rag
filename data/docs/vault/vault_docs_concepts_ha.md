...
- Vault
- [v1.20.x](/vault/docs/v1.20.x/concepts/ha)
- [v1.19.x](/vault/docs/v1.19.x/concepts/ha)
- [v1.18.x](/vault/docs/v1.18.x/concepts/ha)
- [v1.17.x](/vault/docs/v1.17.x/concepts/ha)
- [v1.16.x](/vault/docs/v1.16.x/concepts/ha)
- ---
...
request, they will either [forward the request](/vault/docs/concepts/ha#request-forwarding) or
[redirect the client](/vault/docs/concepts/ha#client-redirection) depending on the current
...
- [`A`](/vault/docs/concepts/ha#a), accessed via `https://a.vault.mycompany.com:8200`
- [`B`](/vault/docs/concepts/ha#b), accessed via `https://b.vault.mycompany.com:8200`
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/vault/v1.21.x/content/docs/concepts/ha.mdx)