...
- Vault
- [v1.20.x](/vault/docs/v1.20.x/concepts/seal)
- [v1.19.x](/vault/docs/v1.19.x/concepts/seal)
- [v1.18.x](/vault/docs/v1.18.x/concepts/seal)
- [v1.17.x](/vault/docs/v1.17.x/concepts/seal)
- [v1.16.x](/vault/docs/v1.16.x/concepts/seal)
- ---
...
![Shahir seals](https://web-unified-docs-hashicorp.vercel.app/api/assets/vault/latest/img/vault-shamir-seal.png)
...
[auto unseal](/vault/docs/concepts/seal#auto-unseal) provides a better experience.
...
![Auto Unseal](https://web-unified-docs-hashicorp.vercel.app/api/assets/vault/latest/img/vault-auto-unseal.png)
...
- [`recovery-shares`](/vault/docs/concepts/seal#recovery-shares): The number of shares into which to split the recovery
  key. This value is equivalent to the `recovery_shares` value in the API
  endpoint.
- [`recovery-threshold`](/vault/docs/concepts/seal#recovery-threshold): The threshold of shares required to reconstruct the
  recovery key. This value is equivalent to the `recovery_threshold` value in
  the API endpoint.
- [`recovery-pgp-keys`](/vault/docs/concepts/seal#recovery-pgp-keys): The PGP keys to use to encrypt the returned recovery
...
2. Send the Vault process the SIGHUP signal to trigger a configuration reload.
3. Monitor the [`sys/sealwrap/rewrap`](/vault/api-docs/system/sealwrap-rewrap) endpoints,
...
4. Edit the Vault configuration, and remove the old seal configuration.
5. Send the Vault process the SIGHUP signal, again allowing rewrapping to complete.
...
2. Perform step 1 for all the standby nodes, one at a time. You must
   ...
   quorum.
3. [Step down](/vault/docs/commands/operator/step-down) the
...
4. The new active node performs the migration. Monitor the server log in
...
2. You can now update the configuration files of all the nodes to have only the
...
auto seals in a simplified manner. For more information, refer to [Migration post Vault 1.16.0 via seal HA for auto seals](/vault/docs/concepts/seal#migration-post-vault-1-16-0-via-seal-ha-for-auto-seals-enterprise).
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/vault/v1.21.x/content/docs/concepts/seal.mdx)