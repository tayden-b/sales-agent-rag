# Source: https://developer.hashicorp.com/vault/docs/platform/k8s/helm/run

v1.21.x (latest)

- Vault
- [v1.20.x](/vault/docs/v1.20.x/deploy/kubernetes/helm/run)
- [v1.19.x](/vault/docs/v1.19.x/deploy/kubernetes/helm/run)
- [v1.18.x](/vault/docs/v1.18.x/deploy/kubernetes/helm/run)
- [v1.17.x](/vault/docs/v1.17.x/deploy/kubernetes/helm/run)
- [v1.16.x](/vault/docs/v1.16.x/deploy/kubernetes/helm/run)
- ---
...
2. Confirm Vault removed the node successfully from Raft with
   `vault operator raft list-peers`.
3. Once you confirm the removal, delete the pod.

Delete nodes to avoid unnecessary leader elections
...
[upgrade section](/vault/docs/deploy/kubernetes/helm/run#how-to) for instructions
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/vault/v1.21.x/content/docs/deploy/kubernetes/helm/run.mdx)