# Source: https://developer.hashicorp.com/vault/docs/enterprise/replication

v1.21.x (latest)

- Vault
- [v1.20.x](/vault/docs/v1.20.x/enterprise/replication)
- [v1.19.x](/vault/docs/v1.19.x/enterprise/replication)
- [v1.18.x](/vault/docs/v1.18.x/enterprise/replication)
- [v1.17.x](/vault/docs/v1.17.x/enterprise/replication)
- [v1.16.x](/vault/docs/v1.16.x/enterprise/replication)
- ---
...
![](https://web-unified-docs-hashicorp.vercel.app/api/assets/vault/latest/img/replication-overview.png)
...
- [`replicated`](/vault/docs/enterprise/replication#replicated) (or "shared"): all downstream clusters receive it
- [`local`](/vault/docs/enterprise/replication#local): only downstream disaster recovery clusters receive it
- [`ignored`](/vault/docs/enterprise/replication#ignored): not replicated to downstream clusters at all
...
Performance replication does not include automated integrated storage snapshots
...
![Performance Replication - primary](https://web-unified-docs-hashicorp.vercel.app/api/assets/vault/latest/img/vault-mount-filter-7.png)
...
Refer to the *manage replicated mounts* section in the [Set up performance
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/vault/v1.21.x/content/docs/enterprise/replication/index.mdx)