# Source: https://developer.hashicorp.com/vault/docs/concepts/identity

v1.21.x (latest)

- Vault
- [v1.20.x](/vault/docs/v1.20.x/concepts/identity)
- [v1.19.x](/vault/docs/v1.19.x/concepts/identity)
- [v1.18.x](/vault/docs/v1.18.x/concepts/identity)
- [v1.17.x](/vault/docs/v1.17.x/concepts/identity)
- [v1.16.x](/vault/docs/v1.16.x/concepts/identity)
- ---
...
![Entity  overview](https://web-unified-docs-hashicorp.vercel.app/api/assets/vault/latest/img/vault-identity-doc-1.png)
...
![Valid Alias Mapping](https://web-unified-docs-hashicorp.vercel.app/api/assets/vault/latest/img/vault-identity-doc-4.png)
![Invalid Alias Mapping](https://web-unified-docs-hashicorp.vercel.app/api/assets/vault/latest/img/vault-identity-doc-5.png)
...
synced against Vault. In some sense, Vault will serve as a *cache* of
identities and not as a *source* of identities.
...
![Entity policies](https://web-unified-docs-hashicorp.vercel.app/api/assets/vault/latest/img/vault-identity-doc-2.png)

This is a paradigm shift in terms of *when* the policies of the token get
...
*additional* capabilities and not a replacement for the policies on the token.
...
an entity. If no entities are explicitly created or merged, then one [entity will be implicitly created](/vault/docs/concepts/identity#implicit-entities)
...
![Identity overview](https://web-unified-docs-hashicorp.vercel.app/api/assets/vault/latest/img/vault-identity-doc-3.png)
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/vault/v1.21.x/content/docs/concepts/identity.mdx)