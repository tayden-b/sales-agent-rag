...
- Vault
- [v1.20.x](/vault/docs/v1.20.x/auth/kubernetes)
- [v1.19.x](/vault/docs/v1.19.x/auth/kubernetes)
- [v1.18.x](/vault/docs/v1.18.x/auth/kubernetes)
- [v1.17.x](/vault/docs/v1.17.x/auth/kubernetes)
- [v1.16.x](/vault/docs/v1.16.x/auth/kubernetes)
- ---
...
You can also use a Kubernetes Service Account Token to [log in via JWT auth](/vault/docs/auth/jwt/oidc-providers/kubernetes).
See the section on [How to work with short-lived Kubernetes tokens](/vault/docs/auth/kubernetes#how-to-work-with-short-lived-kubernetes-tokens)
...
See [Kubernetes 1.21](/vault/docs/auth/kubernetes#kubernetes-1-21) below for more details.
...
1. Enable the Kubernetes auth method:
   ...
   ```
2. Use the `/config` endpoint to configure Vault to talk to Kubernetes. Use
...
Starting in version [1.21](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.21.md#api-change-2), the Kubernetes
...
`TokenReview` API. See [How to work with short-lived Kubernetes tokens](/vault/docs/auth/kubernetes#how-to-work-with-short-lived-kubernetes-tokens)
...
[Discovering the service account `issuer`](/vault/docs/auth/kubernetes#discovering-the-service-account-issuer)
...
[--service-account-extend-token-expiration=false](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-apiserver/#options) for
...
If you leave `kubernetes\_ca\_cert` unset and set `disable\_local\_ca\_jwt` to `true`, Vault uses the system's trust store for TLS certificate verification.
...
provider. The JWT auth method documentation has [instructions](/vault/docs/auth/jwt/oidc-providers/kubernetes) for
...
This auth method accesses the [Kubernetes TokenReview API](https://kubernetes.io/docs/reference/kubernetes-api/authentication-resources/token-review-v1/) to
...
[Edit this page on GitHub](https://github.com/hashicorp/web-unified-docs/blob/main/content/vault/v1.21.x/content/docs/auth/kubernetes.mdx)